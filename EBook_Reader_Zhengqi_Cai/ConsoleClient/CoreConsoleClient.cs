...
namespace ConsoleClient
{
  class CoreConsoleClient
  {
    ...
    public async Task<HttpResponseMessage> CreateBook(string fileSpec)
    {
      ...
      multiContent.Add(bytes, "files", fileName);
            ...
            multiContent.Add(new StringContent("mytitle"), "title");
    ...
    public async Task<IEnumerable<ViewBook>> GetBookList()
    {
            ...
            if (resp.IsSuccessStatusCode)
      {
        ...
        foreach (var item in jArr)
                {
                    ViewBook vbook = item.ToObject<ViewBook>();
                    vBooks.Add(vbook);
